...
// Toggle between PCA9685 I2C control and RP2040 serial bridge.
// Uncomment to build against the Pico RP2040 serial interface.
#define TRAXXAS_USE_PICO_RP2
...
constexpr uint16_t CALIBRATE_FULL_FORWARD_PERIOD_IN_MILLISECS = 4000;    // Period of full forward command during calibration
constexpr uint16_t CALIBRATE_FULL_REVERSE_PERIOD_IN_MILLISECS = 4000;    // Period of full reverse command during calibration
...
constexpr uint16_t ESC_MINIMUM_PULSE_WIDTH =  1025;
constexpr uint16_t DEFAULT_ESC_NEUTRAL_PULSE_WIDTH =  1500;
